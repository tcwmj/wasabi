...
public class AppiumDriverWrapper implements IAppiumDriverWrapper {
...
//        }
    ...
    private class ActionsWrapper implements IActionsWrapper {
        ...
        @Override
        public void performMultiTouchAction(final MultiTouchAction multiAction) {
            logger.debug("");
    ...
    private class WebElementWrapper implements IWebElementWrapper {
        ...
        public IAppiumDriverWrapper switchTo() {
            ...
            return AppiumDriverWrapper.this;
        }
...
//                        logger.debug("waiting jQuery to be inactive");
    ...
    private class FluentWebElementWrapperAssertion implements IFluentLocatorAssertion {
        ...
        public AbstractListAssert<? extends AbstractListAssert, ? extends List, String> allSelectedTexts() {
            return Assertions.assertThat(webElementWrapper.getAllSelectedTexts()).as("assert %s all selected texts", webElementWrapper);
        }

        @Override
        public AbstractCharSequenceAssert<?, String> selectedText() {
            return Assertions.assertThat(webElementWrapper.getSelectedText()).as("assert %s selected text", webElementWrapper);
        }

        @Override
        public AbstractListAssert<? extends AbstractListAssert, ? extends List, String> allOptionTexts() {
            return Assertions.assertThat(webElementWrapper.getAllOptionTexts()).as("assert %s all option texts", webElementWrapper);
        }

        @Override
        public AbstractBooleanAssert<?> present() {
            return Assertions.assertThat(webElementWrapper.isPresent()).as("assert %s present", webElementWrapper);
        }

        @Override
        public AbstractBooleanAssert<?> enabled() {
            return Assertions.assertThat(webElementWrapper.isEnabled()).as("assert %s enabled", webElementWrapper);
        }

        @Override
        public AbstractBooleanAssert<?> displayed() {
            return Assertions.assertThat(webElementWrapper.isDisplayed()).as("assert %s displayed", webElementWrapper);
        }

        @Override
        public AbstractBooleanAssert<?> selected() {
            return Assertions.assertThat(webElementWrapper.isSelected()).as("assert %s selected", webElementWrapper);
        }

        @Override
        public AbstractCharSequenceAssert<?, String> innerText() {
            return Assertions.assertThat(webElementWrapper.getInnerText()).as("assert %s innertText", webElementWrapper);
        }

        @Override
        public AbstractListAssert<? extends AbstractListAssert, ? extends List, String> allInnerTexts() {
            return Assertions.assertThat(webElementWrapper.getAllInnerTexts()).as("assert %s all innerTexts", webElementWrapper);
        }

        @Override
        public AbstractCharSequenceAssert<?, String> attributeValueOf(String attribute) {
            return Assertions.assertThat(webElementWrapper.getAttribute(attribute)).as("assert %s attribute value of %s", webElementWrapper, attribute);
        }

        @Override
        public AbstractCharSequenceAssert<?, String> cssValueOf(String cssAttribute) {
            return Assertions.assertThat(webElementWrapper.getCssValue(cssAttribute)).as("assert %s css value of %s", webElementWrapper, cssAttribute);
        }

        @Override
        public AbstractIntegerAssert<? extends AbstractIntegerAssert<?>> numberOfElements() {
            return Assertions.assertThat(webElementWrapper.getNumberOfMatches()).as("assert number of elements %s", webElementWrapper);
        }
    ...
    private class FluentLocatorAssertion implements IFluentLocatorAssertion {
        ...
        @Override
        public AbstractListAssert<? extends AbstractListAssert, ? extends List, String> allSelectedTexts() {
            return Assertions.assertThat(element(locator).getAllSelectedTexts()).as("assert %s all selected texts", locator);
        }

        @Override
        public AbstractCharSequenceAssert<?, String> selectedText() {
            return Assertions.assertThat(element(locator).getSelectedText()).as("assert %s selected text", locator);
        }

        @Override
        public AbstractListAssert<? extends AbstractListAssert, ? extends List, String> allOptionTexts() {
            return Assertions.assertThat(element(locator).getAllOptionTexts()).as("assert %s all option texts", locator);
        }

        @Override
        public AbstractBooleanAssert<?> present() {
            return Assertions.assertThat(element(locator).isPresent()).as("assert %s present", locator);
        }

        @Override
        public AbstractBooleanAssert<?> enabled() {
            return Assertions.assertThat(element(locator).isEnabled()).as("assert %s enabled", locator);
        }

        @Override
        public AbstractBooleanAssert<?> displayed() {
            return Assertions.assertThat(element(locator).isDisplayed()).as("assert %s displayed", locator);
        }

        @Override
        public AbstractBooleanAssert<?> selected() {
            return Assertions.assertThat(element(locator).isSelected()).as("assert %s selected", locator);
        }

        @Override
        public AbstractCharSequenceAssert<?, String> innerText() {
            return Assertions.assertThat(element(locator).getInnerText()).as("assert %s innertText", locator);
        }

        @Override
        public AbstractListAssert<? extends AbstractListAssert, ? extends List, String> allInnerTexts() {
            return Assertions.assertThat(element(locator).getAllInnerTexts()).as("assert %s all innerTexts", locator);
        }

        @Override
        public AbstractCharSequenceAssert<?, String> attributeValueOf(String attribute) {
            return Assertions.assertThat(element(locator).getAttribute(attribute)).as("assert %s attribute value of %s", locator, attribute);
        }

        @Override
        public AbstractCharSequenceAssert<?, String> cssValueOf(String cssAttribute) {
            return Assertions.assertThat(element(locator).getCssValue(cssAttribute)).as("assert %s css value of %s", locator, cssAttribute);
        }

        @Override
        public AbstractIntegerAssert<? extends AbstractIntegerAssert<?>> numberOfElements() {
            return Assertions.assertThat(element(locator).getNumberOfMatches()).as("assert number of elements %s", locator);
        }
    ...
    private class FluentAssertion implements IFluentAssertion {
        ...
        public IFluentAlertAssertion alert() {
            return new IFluentAlertAssertion() {
                @Override
                public AbstractBooleanAssert<?> present() {
                    return Assertions.assertThat(AppiumDriverWrapper.this.alert().isPresent()).as("assert alert present");
                }

                @Override
                public AbstractCharSequenceAssert<?, String> text() {
                    return Assertions.assertThat(AppiumDriverWrapper.this.alert().getText()).as("assert alert text");
                }
            };
        }
        ...
        public IFluentPageAssertion page() {
            return new IFluentPageAssertion() {
                ...
                public AbstractCharSequenceAssert<?, String> title() {
                    return Assertions.assertThat(getPageTitle()).as("assert page title");
                }

                @Override
                public AbstractCharSequenceAssert<?, String> source() {
                    return Assertions.assertThat(getPageSource()).as("assert page source");
                }

                @Override
                public AbstractCharSequenceAssert<?, String> url() {
                    return Assertions.assertThat(getCurrentUrl()).as("assert current url");
                }
            };
        }
    }
    ...
    private class FluentValidation implements IFluentAssertion {
        ...
        public IFluentAlertAssertion alert() {
            return new IFluentAlertAssertion() {
                @Override
                public AbstractBooleanAssert<?> present() {
                    return softAssertions.assertThat(AppiumDriverWrapper.this.alert().isPresent()).as("validate alert present");
                }

                @Override
                public AbstractCharSequenceAssert<?, String> text() {
                    return softAssertions.assertThat(AppiumDriverWrapper.this.alert().getText()).as("validate alert text");
                }
            };
        }
