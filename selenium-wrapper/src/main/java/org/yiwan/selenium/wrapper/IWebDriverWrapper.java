 ...
 */
public interface IWebDriverWrapper extends IDriverWrapper {
    ...
    interface IWebElementWrapper {
        /**
         * click wrapper element if it's clickable, please use this click method as default
         */
        ...
        /**
         * double click wrapper element if it's clickable
         */
        ...
        /**
         * Type value into the wrapper edit box if it's visible
         *
         * @param value
         */
        ...
        /**
         * Clear the content of the wrapper edit box if it's visible
         */
        IWebElementWrapper clear();

        /**
         * clear the wrapper edit box and input the value
         *
         * @param value
         */
        ...
        /**
         * check wrapper check box on or off if it's visible
         *
        ...
        /**
         * using java script to check wrapper check box on or off
         *
         * @param checked on or off
         */
        ...
        /**
         * wrapper check box checked or not
         *
        ...
        /**
         * get text on such wrapper element
         *
         * @return string
         */
        String getInnerText();
        ...
        /**
         * set innert text on such wrapper element by javascript
         *
         * @param text
         */
        ...
        /**
         * set value on such wrapper element by javascript, an alternative approach for method input
         *
         * @param value
         */
        ...
        /**
         * get all selected options in wrapper list element
         *
        ...
        /**
         * get all options in wrapper list element
         *
         * @return List&gt;WebElement&lt;
         */
        ...
        /**
         * get all options text in wrapper list element
         *
         * @return List&gt;String&lt;
         */
        ...
        /**
         * get first selected option's text in wrapper list element
         *
         * @return string
         */
        ...
        /**
         * get all selected options' text in wrapper list element
         *
         * @return List&gt;String&lt;
         */
        ...
        /**
         * using java script to get row number of cell element "/td" in wrapper table
         */
        long getCellRow();

        /**
         * using java script to get column number of cell element "/td" in wrapper table
         */
        long getCellColumn();

        /**
         * using java script to get row number of row element "/tr" in wrapper table
         */
        long getRow();

        /**
         * using java script to get row count of wrapper table "/table"
         *
         * @return long
         */
        long getRowCount();
        ...
        /**
         * get all matched wrapper elements
         *
